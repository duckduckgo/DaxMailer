package Dancer2::Plugin::DaxMailer::Bailout;

# ABSTRACT: Bailing out of DaxMailer service request with errors
...
Dancer2::Plugin::DaxMailer::Bailout - Bailing out of DaxMailer service requests with
errors
...
Dancer2::Plugin::DaxMailer::Bailout provides C<bailout>, which will exit the current
